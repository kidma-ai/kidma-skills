...
- `kidma-plugins:kidma-brand-guidelines skill` — for Kidma's official colors, typography, logo variants, and light/dark mode rules. Use when adding new slides, picking accent colors, or inserting logos beyond what the template provides.
